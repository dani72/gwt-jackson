 ...
 */
public class JsonDeserializeBuilderJacksonTest extends AbstractJacksonTest {

    @Test
    public void testDeserialize() {
        JsonDeserializeBuilderTester.INSTANCE
                .testDeserialize( createReader( Animal.class ) );
    }
