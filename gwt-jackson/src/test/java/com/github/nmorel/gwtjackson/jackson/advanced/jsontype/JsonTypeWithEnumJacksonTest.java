 ...
 */
public class JsonTypeWithEnumJacksonTest extends AbstractJacksonTest {

    @Test
    public void testWithJsonTypeInfo() {
        JsonTypeWithEnumTester.INSTANCE.testWithJsonTypeInfo( createMapper( HasCodeWrapperBean.class ) );
    }

    @Test
    public void testSerializeWithoutJsonTypeInfo() {
        JsonTypeWithEnumTester.INSTANCE.testSerializeWithoutJsonTypeInfo( createWriter( new TypeReference<List<HasCode>>() {} ) );
    }
}
